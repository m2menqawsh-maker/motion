...
| `Introwrapper` | C | `templates/scenes/IntroWrapper.tsx` | ui_element, windows, hook |
...
| `Calendarmonthfillwrapper` | C | `templates/elements/CalendarMonthFillWrapper.tsx` | ui_element, windows, cta |
...
| `Codediffwipewrapper` | C | `templates/elements/CodeDiffWipeWrapper.tsx` | code_demo, ui_element, windows, transition |
...
| `Comparisontablewrapper` | C | `templates/elements/ComparisonTableWrapper.tsx` | data_display, ui_element, navigation, windows |
...
| `Endcardwrapper` | C | `templates/elements/EndCardWrapper.tsx` | ui_element, windows, cta |
...
| `Hookcardwrapper` | C | `templates/elements/HookCardWrapper.tsx` | ui_element, windows, hook |
...
| `Staggeredmotionwrapper` | C | `templates/elements/StaggeredMotionWrapper.tsx` | ui_element, badge, element_animation, windows |
