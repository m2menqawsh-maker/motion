...
| `Dataflowpipeswrapper` | C | `templates/scenes/DataFlowPipesWrapper.tsx` | windows, data_display, ui_element |
| `Datastorywrapper` | C | `templates/scenes/DataStoryWrapper.tsx` | windows, data_display, ui_element |
...
| `Landingcodeshowcasewrapper` | C | `templates/scenes/LandingCodeShowcaseWrapper.tsx` | windows, ui_element, code_demo |
| `Livecodesplitwrapper` | C | `templates/scenes/LiveCodeSplitWrapper.tsx` | windows, ui_element, code_demo |
...
| `Calendarmonthfillwrapper` | C | `templates/elements/CalendarMonthFillWrapper.tsx` | windows, cta, ui_element |
...
| `Chattopreviewwrapper` | C | `templates/elements/ChatToPreviewWrapper.tsx` | windows, messaging, ui_element |
| `Codeaccordionwrapper` | C | `templates/elements/CodeAccordionWrapper.tsx` | windows, ui_element, code_demo |
| `Codeblockwrapper` | C | `templates/elements/CodeBlockWrapper.tsx` | windows, ui_element, code_demo |
| `Codediffwipewrapper` | C | `templates/elements/CodeDiffWipeWrapper.tsx` | windows, transition, ui_element, code_demo |
| `Coderevealwrapper` | C | `templates/elements/CodeRevealWrapper.tsx` | windows, ui_element, code_demo |
| `Commentcalloutwrapper` | C | `templates/elements/CommentCalloutWrapper.tsx` | windows, ui_element |
| `Commitgraphwrapper` | C | `templates/elements/CommitGraphWrapper.tsx` | windows, ui_element, stat |
| `Comparisontablewrapper` | C | `templates/elements/ComparisonTableWrapper.tsx` | windows, data_display, ui_element, navigation |
| `Countdowntimerwrapper` | C | `templates/elements/CountdownTimerWrapper.tsx` | windows, ui_element, stat |
...
| `Devicemockupzoomwrapper` | C | `templates/elements/DeviceMockupZoomWrapper.tsx` | windows, ui_element, image_motion |
| `Endcardwrapper` | C | `templates/elements/EndCardWrapper.tsx` | windows, cta, ui_element |
| `Faqaccordionwrapper` | C | `templates/elements/FaqAccordionWrapper.tsx` | windows, ui_element |
| `Featurelistwrapper` | C | `templates/elements/FeatureListWrapper.tsx` | windows, data_display, ui_element |
...
| `Notificationstackwrapper` | C | `templates/elements/NotificationStackWrapper.tsx` | windows, ui_element, notification |
...
| `Searchresultspopulatewrapper` | C | `templates/elements/SearchResultsPopulateWrapper.tsx` | windows, search_ui, ui_element |
...
| `Staggeredmotionwrapper` | C | `templates/elements/StaggeredMotionWrapper.tsx` | element_animation, windows, ui_element, badge |
...
| `Terminalsimulatorwrapper` | C | `templates/elements/TerminalSimulatorWrapper.tsx` | windows, ui_element, code_demo |
...
| `Zoompanframewrapper` | C | `templates/elements/ZoomPanFrameWrapper.tsx` | windows, ui_element, image_motion |
