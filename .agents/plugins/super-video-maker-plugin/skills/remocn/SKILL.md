---
name: remocn
description: Build Remotion videos with remocn. You only select components from the template registry and plan the blueprint. Do not build videos manually.
---
