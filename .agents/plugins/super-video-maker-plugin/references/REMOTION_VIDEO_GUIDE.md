...
**Studio:** `cd remotion-app && npx remotion studio` → composition **`CaptionedTalkingHead`**.
...
- Remotion compositions live in `remotion-app/src/`
- Remotion assets MUST be placed in `remotion-app/public/`.
