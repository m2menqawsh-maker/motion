...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="بوابات الخط المرحلي")
    parser.add_argument("project_id", help="معرف المشروع (أو مسار المشروع)")
    parser.add_argument("--report", action="store_true", help="تقرير حالة المشروع")
    parser.add_argument("--check", dest="target", help="فحص مرحلة معينة")
    args = parser.parse_args()

    proj = Path(args.project_id)
