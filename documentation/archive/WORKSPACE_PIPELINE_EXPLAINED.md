...
│       ├── master_plan.md                  # الخطة الشاملة والعمود الفقري
...
│       ├── 05_05_blueprint.json           # المخطط الزمني الكامل للتنفيذ البرمجي
...
flowchart TD
    ...
    SmartQ -->|إجابات المستخدم| Plan[المرحلة 1: الخطة الشاملة master_plan.md]
...
5. **🛑 التوقف 2:** إنشاء `master_plan.md` وانتظار موافقة المستخدم الصريحة.
...
| `master_plan.md` | المرحلة 1 | الخطة الشاملة، العمود الفقري، واقتباسات الذوق الإخراجي والقوالب المعتمدة. |
...
| `05_05_blueprint.json` | المرحلة 2/3 | المخطط البرمجي الهيكلي الكامل للمشروع (Timeline, Layers, Elements, SFX cues). |
...
- **آلية الفحص:** 
  - يفحص وجود `master_plan.md` والتأكد من احتوائه على شخصية موشن واقتباس `motion_taste_citation`.
