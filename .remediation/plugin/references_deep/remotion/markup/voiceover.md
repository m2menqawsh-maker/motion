...
Use [`calculateMetadata`](./calculate-metadata.md) to measure the [audio durations](../multimedia/get-audio-duration.md) and set the composition length accordingly.
