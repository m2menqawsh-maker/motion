...
import { CountUp } from '@/components/onda/count-up/CountUp';
import { WordStagger } from '@/components/onda/word-stagger/WordStagger';
    ...
    <PlacementBox placement={placement}>
      <div
        style={{
          ...
          gap: 24,
          direction: 'rtl',
          fontFamily: fontFamily || '"Cairo", "Alexandria", sans-serif',
        }}
      >
