...
| اسم المكتبة | الوصف | طريقة الاستخدام |
|---|---|---|
| **`@remotion/transitions`** | مكتبة رسمية توفر انتقالات سينمائية جاهزة (Wipe, Fade, Slide). | `npm install @remotion/transitions` |
| **`remotion-bits`** | مكونات جاهزة مثل نصوص متحركة، Particles، ورسوم بيانية. | نسخ الكود المصدري `.tsx` |
| **`remotion-ui`** | مكونات واجهة مستخدم مجهزة للعمل مع الفيديو. | عبر الـ CLI الخاص بهم |
| **`snap-cn` (Internal)** | النواة الداخلية لمشروعنا (تشبه Shadcn لريموشن). | مكونات تُبنى برمجياً داخلياً |
